<div id="content">
            <div class="menu-header">
                ...
                <span class="menu-text">Manage BV Percent</span>
            </div>
            <!-- row begins -->
            <div class="row">
                <div class="col-md-8">
					<form action="<?php echo base_url(); ?>admin/bv_percent_manage/updateData" method="POST" enctype="multipart/form-data">
					<?php $updateMessage = $this->session->flashdata('adm_bv_data_updated');?>
					<?php 
						if ($updateMessage) {
							echo '<div class="text-success">' . $updateMessage . '</div>'; 
						}
					?>
						<?php $bv_data = $this->session->flashdata('adm_bv_data');?>
						<div class="form-row">
